...
* @return null
*/
function phpbb_update_rows_avoiding_duplicates(\phpbb\db\connection $db, $table, $column, $from_values, $to_value)
{
...
* @return null
*/
function phpbb_update_rows_avoiding_duplicates_notify_status(\phpbb\db\connection $db, $table, $column, $from_values, $to_value)
{
