...
{
	/**
	 * Allows to check if the migration is effectively installed (entirely optional).
	 *
	 * This is checked when a migration is installed.
	 * If true is returned, the migration will be set as installed without performing the database changes.
	 ...
	 * 							False if this migration is not installed (checked on install)
	 */
	 ...
	 * 	otherwise irreversible calls (custom functions for example).
	 *
	 ...
	 *
	 * The schema changes have to be compatible with
	 * @see \phpbb\db\tools::perform_schema_changes()
	 *
