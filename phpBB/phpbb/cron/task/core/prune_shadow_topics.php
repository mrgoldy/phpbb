...
class prune_shadow_topics extends \phpbb\cron\task\base implements \phpbb\cron\task\parametrized
{
	...
	* @param \phpbb\db\connection $db The db connection
	* @param \phpbb\log\log $log The phpBB log system
	* @param \phpbb\user $user The phpBB user object
	*/
	public function __construct($phpbb_root_path, $php_ext, \phpbb\config\config $config, \phpbb\db\connection $db, \phpbb\log\log $log, \phpbb\user $user)
	{
