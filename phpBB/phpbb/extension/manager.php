...
class manager
{
	...
	*/
	public function __construct(ContainerInterface $container, \phpbb\db\connection $db, \phpbb\config\config $config, $extension_table, $phpbb_root_path, $php_ext = 'php', \phpbb\cache\service $cache = null, $cache_name = '_ext')
	{
		$this->cache = $cache;
